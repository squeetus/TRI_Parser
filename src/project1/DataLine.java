...
public class DataLine {
	...
	public void parseLine(String line) {   
		...
		recovery = Float.valueOf(splitLine[91]) + Float.valueOf(splitLine[92]);
		recycling = Float.valueOf(splitLine[93]) + Float.valueOf(splitLine[94]);
		treatment = Float.valueOf(splitLine[95]) + Float.valueOf(splitLine[96]);
