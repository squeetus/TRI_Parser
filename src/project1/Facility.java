...
public class Facility {
	...
	private Float recovery, recycling, treatment;
	...
	Facility(DataLine d) {
		...
		recovery = d.getRecovery();
		recycling = d.getRecycling();
	...
	public void addRecovery(Float r) {
		recovery += r;
	}
	
	public void addRecycling(Float r) {
		recycling += r;
	}
	
	public void addTreatment(Float t) {
		treatment += t;
	}
